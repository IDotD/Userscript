        ...
        var toggleGUI = function(onOff) {
          ...
          if (toggle === true) {
            ...
            while (idrinth.war.element.childNodes[1].childNodes[1].firstChild) {
              idrinth.war.element.childNodes[1].childNodes[1].removeChild(
                idrinth.war.element.childNodes[1].firstChild.firstChild
              );
            }
          }
        ...
        var processJson = function(data) {
          ...
          function addRaids(raids) {
            for (var key in raids) {
              if (
                idrinth.raids.joined[key] === undefined &&
                idrinth.raids.list[key] === undefined
              ) {
          ...
          function updateBoss(data, element) {
            ...
            function cleanUp() {
              while (element.getElementsByTagName("td")[3].firstChild) {
                element
                  ...
                  .removeChild(
                    element.getElementsByTagName("td")[3].firstChild
                  );
              }
            }
            ...
            for (var m = 0; m < tmpMagics.length; m++) {
              element
                .getElementsByTagName("td")[3]
                .appendChild(idrinth.ui.buildElement(tmpMagics[m]));
            }
            element
              ...
              .setAttribute(
                ...
                "traffic " +
                  (data.amount < 90
                    ? "yes"
                    : data.amount > 110 ? "no" : "maybe")
              );
            element
              .getElementsByTagName("td")[0]
              .setAttribute("title", data.amount + "/100");
          ...
          for (var boss in data.stats) {
            if (document.getElementById("idrinth-war-" + boss)) {
              updateBoss(
                data.stats[boss],
                document.getElementById("idrinth-war-" + boss)
              );
            } else {
